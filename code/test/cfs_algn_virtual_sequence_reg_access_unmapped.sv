`ifndef CFS_ALGN_VIRTUAL_SEQUENCE_REG_ACCESS_UNMAPPED_SV
    ...
    class cfs_algn_virtual_sequence_reg_access_unmapped
        ...
        virtual task body();
            ...
            for (int unsigned access_index = 0; access_index < num_accesses; access_index++) begin
        ...
        // Here we make the assumption that the width of all registers is multiple of 8
        ...
        // TODO: Move it on the super class
