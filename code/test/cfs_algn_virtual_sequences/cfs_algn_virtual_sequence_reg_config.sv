`ifndef CFS_ALGN_VIRTUAL_SEQUENCE_REG_CONFIG_SV
    ...
    class cfs_algn_virtual_sequence_reg_config
        ...
        virtual task body();
            ...
            for (int reg_idx = registers.size() - 1; reg_idx >= 0; reg_idx--) begin: FILTER_READ_REGS
            ...
            foreach(registers[reg_idx]) begin: WRITE_TO_REGISTERS
